  ...
  return (
    <div className="fixed inset-0 z-50 bg-black/90 backdrop-blur-sm">
      <div className="flex min-h-screen items-center justify-center px-2 py-4 sm:px-6">
        ...
        <button
          onClick={onClose}
          className="absolute right-3 top-3 z-10 flex h-10 w-10 items-center justify-center rounded-full border border-white/10 bg-white/10 text-white transition hover:bg-white/20 sm:h-11 sm:w-11 sm:right-6 sm:top-6"
        >
          ✕
        </button>
        ...
        {images.length > 1 && (
          <button
            onClick={prev}
            className="absolute left-2 top-1/2 z-10 flex h-10 w-10 -translate-y-1/2 items-center justify-center rounded-full border border-white/10 bg-white/10 text-xl text-white transition hover:bg-white/20 sm:left-6 sm:h-11 sm:w-11 sm:text-2xl"
          >
            ‹
          </button>
        )}
        ...
        {images.length > 1 && (
          <button
            onClick={next}
            className="absolute right-2 top-1/2 z-10 flex h-10 w-10 -translate-y-1/2 items-center justify-center rounded-full border border-white/10 bg-white/10 text-xl text-white transition hover:bg-white/20 sm:right-6 sm:h-11 sm:w-11 sm:text-2xl"
          >
            ›
          </button>
        )}
