...
const Home = () => {
  ...
  // ✅ FIX: move params + query OUTSIDE useEffect
  ...
  // ✅ FIX: now accessible in JSX
  const hasFilters =
    query.search || query.category || query.brand || query.ordering;
...
//     const hasFilters = query.search || query.category || query.brand || query.ordering;
//     const isFirstPage = query.page === 1;
